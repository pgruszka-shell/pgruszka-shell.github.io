...
const baseRequest = {
  ...
    parameters: {
      'gateway': 'adyen',
      'gatewayMerchantId': 'ShellInternationalPetroleumCompany_Shell_Smartpay_FR_TEST'
    }
  };
  ...
  function changeMerchantID(){
    var merchantId = document.getElementById("merchantId").value;
    document.getElementById("merchantId1").value = merchantId;
  ...
  function changeMerchant(){
    var merchantId = document.getElementById("merchantId1").value;
  ...
  var obj = paymentData.paymentMethodData.tokenizationData.token;
    var myJSON = JSON.stringify(obj);
    document.getElementById("token").value= myJSON;
